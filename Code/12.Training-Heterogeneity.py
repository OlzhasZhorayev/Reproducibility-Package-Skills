...
for group in df['Group'].unique():
    ...
    ax.text(-0.55, mid_pos, group,  # Adjust the Group label position to the left: -0.30 for sheet2
...
for group in unique_groups:
    ...
    ax.hlines(y=lower_bound, xmin=-0.02, xmax=1.00, color='gray', linestyle='--', linewidth=0.5) 
    # Adjust xmax = 1.00 for Sheet2

# Adjust layout and save the plot
plt.subplots_adjust(left=0.45, right=0.9, top=0.95, bottom=0.1)
#output_file = '/Users/Admin/OneDrive - George Mason University - O365 Production/Documents/GMU/Dr Kugler/Skills/Reproducibility Package/Figures/Figure5.TrainingHeterogeneity.png'
output_file = FIG_DIR / "Figure5.TrainingHeterogeneity.png"
