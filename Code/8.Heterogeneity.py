...
#file_path = '/Users/Admin/OneDrive - George Mason University - O365 Production/Documents/GMU/Dr Kugler/Skills/Reproducibility Package/Temp/Pooled_Estimates_RE_All.xlsx'
...
for group in df['Group'].unique():
    ...
    ax.text(-0.07, mid_pos, group, verticalalignment='center', horizontalalignment='center', 
            ...
            # Adjust the label position to the left: -0.06 for sheet2
...
for group in unique_groups:
    ...
    # Adjust xmax = 0.06 for Sheet2

# Adjust layout and save the plot
plt.subplots_adjust(left=0.45, right=0.9, top=0.95, bottom=0.1)
#output_file = '/Users/Admin/OneDrive - George Mason University - O365 Production/Documents/GMU/Dr Kugler/Skills/Reproducibility Package/Figures/Figure2.Heterogeneity.png'
output_file = FIG_DIR / "Figure2.Heterogeneity.png"
